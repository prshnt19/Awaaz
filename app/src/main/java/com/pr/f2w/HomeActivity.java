...
public class HomeActivity extends AppCompatActivity
    ...
    public void do_qna(View v){
        Intent intent = new Intent(HomeActivity.this,QandA.class);
        startActivity(intent);
    }
    public void do_complaint(View view){
        Intent intent1 = new Intent(HomeActivity.this,Complaint.class);
        startActivity(intent1);
    }
    public void do_vote(View v){
        Intent intent = new Intent(HomeActivity.this,Vote.class);
        startActivity(intent);
    }
    public void do_pics(View v){
        Intent intent = new Intent(HomeActivity.this,Picsend.class);
        startActivity(intent);
    }
